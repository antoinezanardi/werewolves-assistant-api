...
| 🐕<br/>dog-wolf               | <img src="https://werewolves-assistant-api.antoinezanardi.fr/img/roles/dog-wolf.png" width="50"/>            | villagers / werewolves  | The first night, he chooses a side between `villagers` and `werewolves`. The, he must win with the chosen side. Other players don't know what he chose.                       |
