...
| meet-each-other   | 👨‍👨‍👦<br/>three-brothers             | 🧑‍🌾<br/>villagers         | -                                | First night and every X night depending on game options. Brief moment in which sisters meet each other and can speak (with gestures).   |
