...
| 🍽️<br/>eaten               | Werewolves decided to eat this player during the night. The player will die the next phase (`day`) if he is the `little-girl` or doesn't have the `protected` or `drank-life-potion` attribute.                                     | 1 phase                                          |
