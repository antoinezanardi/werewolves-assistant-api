...
| 🐐<br/>scapegoat              | <img src="https://werewolves-assistant-api.antoinezanardi.fr/img/roles/scapegoat.png" width="50"/>             | villagers               | If there is a tie in votes, even if the `sheriff` is in the game or he is not in the tie, he will be the vote target. If so, he will choose who won't vote during the next day.                                                      |
...
|:--------------------------:|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------:|
| 🎖️<br/>sheriff             | Elected by all alive players, has the doubled vote. When dying, this attribute is transferred to someone chosen by the player. If there is a tie in the votes during the `day`, the sheriff must settle them.                       | Until `sheriff` player dies                      |
| 👀<br/>seen                | The seer looked at this player during the night. The player's role is revealed to the seer.                                                                                                                                         | 1 phase                                          |
| 🍽️<br/>eaten               | Werewolves or `big-bad-wolf` decided to eat this player during the night. The player will die the next phase (`day`) if he is the `little-girl` or doesn't have the `protected` or `drank-life-potion` attribute.                   | 1 phase                                          |
...
| 🚫🗳️‍<br/>cant-vote         | The player is not able to vote while he has this attribute. If all alive players have this attribute, there is no vote.                                                                                                              | 2 phases<br/>(_1 turn_)                          |
