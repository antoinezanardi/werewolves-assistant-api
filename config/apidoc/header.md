...
| **additionalCards***                                                          | Object[]                              | Game's additional cards. Set if `thief` is in the game.                                                                                                                                                                                                                                       |
| &emsp;⮑ _id                                                                  | ObjectId                              | Additional card's ID.                                                                                                                                                                                                                                                                         |
| &emsp;⮑ role                                                                 | String                                | Additional card's role name. (_See: [Codes - Player Roles](#player-roles)_)                                                                                                                                                                                                                   |
| &emsp;⮑ for                                                                  | String                                | Additional card's recipient. Set to `thief`.                                                                                                                                                                                                                                               |
| &emsp;⮑ isUsed                                                               | Boolean                               | If set to `true`, card has been used by its recipient.                                                                                                                                                                                                                                        |
